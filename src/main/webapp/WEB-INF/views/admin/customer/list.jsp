													...
													<table class="table" style="margin: auto; text-align: center;">
														<thead>
															<tr>
																...
																<th style="margin: auto; text-align: center;">Tên khách hàng</th>
															...
															<c:forEach items="${results}" varStatus="loop"
																...
																<tr>
																	<td style="vertical-align: middle;"><input
																		...
																		value="${contact.id}" id="${loop.count}"
																		style="cursor: pointer;" /></td>
																	<td style="vertical-align: middle;">${contact.email}</td>
																	<td style="vertical-align: middle;">${contact.fullname}</td>
																	<td style="vertical-align: middle;">${contact.phone}</td>
																	<td style="vertical-align: middle;">${contact.address}</td>
																	<td style="vertical-align: middle;">${contact.gender}</td>
