var lp = './img/';
      ...
      var editor  = grapesjs.init({
		...
		canvas: {
			...
			'styles': ['https://w.ladicdn.com/v2/source/ladipage.min.css?v=1636622377674', 'https://fonts.googleapis.com/css?family=Roboto:bold,regular|Anton:bold,regular|Open%20Sans:bold,regular&display=swap']
		},
        plugins: [
