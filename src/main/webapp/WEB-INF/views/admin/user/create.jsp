				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						...
						<div class="panel-heading"
							...
							<h3 class="panel-title">Tạo user</h3>
							<div>							
							...
							<div class="row"
								...
								<table style="margin: auto; margin-left: 60px;" class="col-md-6">
											...
											<td>
												<select name="roleId">
													<c:forEach items="${roles}" var="role">
															<c:choose>
																<c:when test="${role.id == result.role.id}">
										...
										<tr>
											<th>Đơn hàng xử lý gần đây:</th>
											<td>
												<a
													href="/ladibook/admin/order/list?employeeId=${result.id}"> <span
