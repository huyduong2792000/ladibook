...
<head>
    ...
    <script async="" src="../../resource/admin/assets/vendor/grapes/analytics.js"></script><script src="../../resource/admin/assets/vendor/grapes/jquery.min.js"></script>
