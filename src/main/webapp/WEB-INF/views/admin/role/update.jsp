...
<head>
<title>Dashboard | Chỉnh sửa quyền</title>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						...
						<div class="panel-heading"
							...
							<h3 class="panel-title">Quyền ${result.roleName}</h3>
							<div>							
							...
							<div class="row"
								...
								<table style="margin: auto; margin-left: 60px;" class="col-md-6">
										...
										<tr>
											<th>Nhân viên có quyền này:</th>
											<td>
												<a
													href="/ladibook/admin/employee/list?roleId=${result.id}"> <span
